...
export const metadata = {
  ...
  description: "DMCA Copyright Policy for ArtConnect platform.",
};
      ...
      <div className="max-w-3xl mx-auto px-8 py-20">
        ...
        <div className="flex flex-col gap-10 text-sm leading-relaxed text-black/80">
          ...
          <section>
            ...
            <p>ArtConnect respects the intellectual property rights of others and expects all users of our Platform to do the same. In accordance with the Digital Millennium Copyright Act of 1998 ("DMCA"), we will respond promptly to claims of copyright infringement that are reported to our designated copyright agent.</p>
          </section>

          <section>
            <h2 className="text-lg font-black uppercase mb-3 text-black">1. Reporting Copyright Infringement</h2>
            <p className="mb-3">If you believe that content hosted on ArtConnect infringes your copyright, please submit a written notice to our DMCA Agent containing all of the following information:</p>
          ...
          <section>
            ...
            <p className="mb-3">Upon receipt of a valid DMCA takedown notice, ArtConnect will:</p>
            <ul className="list-disc pl-5 flex flex-col gap-2">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 flex flex-col gap-2">
              ...
              <li>A statement that you consent to the jurisdiction of the Federal District Court for the judicial district in which your address is located, or if outside the United States, any judicial district in which ArtConnect may be found</li>
          ...
          <section>
            ...
            <p>ArtConnect is aware that musicians may wish to upload cover versions of copyrighted songs. Please note that performing or recording a cover song does not automatically grant you the right to distribute it. If you upload a cover song, you are responsible for ensuring you have obtained all necessary licenses (such as a mechanical license or synchronization license). ArtConnect does not provide licensing assistance and is not liable for unlicensed cover song uploads.</p>
          </section>
