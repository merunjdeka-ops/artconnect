              ...
              <div className="border border-black overflow-hidden group">
                {isVideo(artist.daily_pic_url!) ? (
                  ...
                  <div className="relative cursor-zoom-in" onClick={() => setStoryOpen(true)}>
                    <img src={cdnUrl(artist.daily_pic_url!, "w_1200,c_limit,q_auto,f_auto")} alt="Daily story" loading="lazy" decoding="async" className="w-full object-cover max-h-[480px] transition-transform duration-300 group-hover:scale-[1.02]" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-px bg-black border border-black mb-10">
                    {portfolio.filter(i => i.media_type === "image").map((item, idx) => (
                      <div key={item.id} className="bg-[#F2EDE4] p-4 group">
                        ...
                        >
                          <img src={cdnUrl(item.media_url, "w_800,c_limit,q_auto,f_auto")} alt={item.title} loading="lazy" decoding="async" className="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-105" />
                          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center">
