...
export const metadata = {
  title: "Terms of Service — goArtConnect",
  description: "Terms of Service for goArtConnect platform.",
};
  ...
  return (
    <main className="min-h-screen bg-[#F2EDE4] text-black font-sans">
      <nav className="flex items-center justify-between px-8 py-5 border-b border-black">
        <Link href="/" className="text-xl font-black tracking-tight leading-none"><span className="text-[#E5000F]" style={{fontFamily:"Purgatory,Georgia,serif", fontWeight:"normal", fontStyle:"normal"}}>go</span><span className="uppercase">ARTCONNECT</span></Link>
      ...
      <div className="max-w-3xl mx-auto px-8 py-20">
        ...
        <div className="flex flex-col gap-10 text-sm leading-relaxed text-black/80">
          ...
          <section>
            ...
            <p>By accessing or using goArtConnect ("Platform", "we", "us", "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the platform. These terms apply to all users, including visitors, registered users, artists, and clients.</p>
          </section>

          <section>
            <h2 className="text-lg font-black uppercase mb-3 text-black">2. Description of Service</h2>
            <p>goArtConnect is an online marketplace that connects local artists — including photographers, musicians, makeup artists, painters, illustrators, videographers, and other creatives — with clients seeking their services. The Platform allows artists to create profiles, upload portfolio content, set rates, and receive bookings. Clients may browse, discover, and book artists through the Platform.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">If you register as an artist on goArtConnect, you agree to:</p>
            <ul className="list-disc pl-5 flex flex-col gap-2">
          ...
          <section>
            ...
            <p className="mb-3">If you use goArtConnect as a client seeking artist services, you agree to:</p>
            <ul className="list-disc pl-5 flex flex-col gap-2">
          ...
          <section>
            ...
            <p>To the fullest extent permitted by law, goArtConnect shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform, including but not limited to loss of profits, data, or goodwill. Our total liability to you for any claim shall not exceed the amount you paid to goArtConnect in the three months preceding the claim.</p>
          </section>
      ...
      <footer className="px-8 py-6 flex flex-wrap gap-4 items-center justify-between border-t border-black mt-10">
        <span className="text-sm font-black tracking-tight leading-none"><span className="text-[#E5000F]" style={{fontFamily:"Purgatory,Georgia,serif", fontWeight:"normal", fontStyle:"normal"}}>go</span><span className="uppercase">ARTCONNECT</span></span>
